...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  },
  {
    ...
    description: "Run open-source LLMs locally on your machine. 100% private, no API key, no rate limit. Requires installing Ollama (~ollama.com).",
    providerType: "ollama",
  ...
  },
  {
    id: "akash",
    label: "Akash Chat",
    description: "Decentralized network. Free tier with rotating large models including Llama 3.3 70B, DeepSeek-R1 671B, Qwen QwQ 32B. Generous limits.",
  ...
  },
  {
    ...
    description: "Serverless inference for HF Hub models via OpenAI-compat router. Free tier with daily quota.",
    providerType: "openai-compatible",
